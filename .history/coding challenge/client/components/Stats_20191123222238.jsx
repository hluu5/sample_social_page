        ...
        <div className="statsContainer">
          <div>
            <div className='thumbNailContainer'>
              <img className='thumbNailImg'src={this.props.thumbnail} onError="this.onerror=null; this.src='https://upload.wikimedia.org/wikipedia/commons/a/ac/No_image_available.svg';"></img>
            </div>
